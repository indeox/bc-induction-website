...
//import TransitionGroup from "react-transition-group/CSSTransitionGroup"; //keeping
import CSSTransitionGroup from "react-addons-css-transition-group"; //"old way"
//import CSSTransitionGroup from "react-transition-group/CSSTransitionGroup"; //"new way"
import "../CSS/info.css";
...
class InfoPage extends React.Component {
  ...
  animFire(splitText) {
    const tl = new TweenMax(), //TimelineMax
    ...
    function turn(group) {
      var tl1 = new TweenMax(); //TimelineMax
  ...
  animBack() {
    ...
    function turnBack(group) {
      let tl3 = new TweenMax(); //TimelineMax
  ...
  animMap(splitText) {
    ...
    function scaleUp(group) {
      let tl2 = new TweenMax(); //TimelineMax
        ...
        >
          ...
          <g style={{ clipPath: "url(#clip-path)" }}>
            <image
              ...
              xlinkHref="https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/persp-map.gif"
            />
            <image
              className="gray"
              ref={c => (this.gray = c)}
              ...
              height="667"
              transform="scale(1.05)"
              xlinkHref="https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/blog-hero2.jpg"
            />
          </g>
          <rect
            id="square"
        ...
        <div className="textarea" ref={c => (this.text = c)}>
          ...
          <div className="staggerP" ref={c => (this.staggerP = c)}>
            <p>
              ...
              illum repellendus, molestiae excepturi quo, ab possimus
              perspiciatis sunt quis. Magni impedit hic culpa, ea. Praesentium
  ...
  return (
    <div className="search">
      ...
      >
        <path
          fill={fillColor}
          d="M64.4,59.5L52.5,47.6c4.1-5.2,6.3-11.5,6.3-18c0-16.1-13.1-29.2-29.2-29.2S0.5,13.6,0.5,29.7s13.1,29.2,29.2,29.2  c6.5,0,12.9-2.2,18-6.3l11.9,11.9c0.7,0.7,1.5,1,2.4,1s1.7-0.3,2.4-1C65.8,63,65.8,60.9,64.4,59.5z M51.8,29.8  C51.8,42,41.9,52,29.7,52S7.5,42,7.5,29.8S17.4,7.6,29.7,7.6S51.8,17.5,51.8,29.8z"
        />
      </svg>
    </div>
  );
